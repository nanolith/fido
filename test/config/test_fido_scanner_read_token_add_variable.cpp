/**
 * \file test/config/test_fido_scanner_read_token_add_variable.cpp
 *
 * \brief Test that we can read an add variable token.
 *
...
TEST_SUITE(fido_scanner_read_token_add_variable);
