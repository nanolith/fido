/**
 * \file test/config/test_fido_scanner_read_token_keyword_role.c
 *
 * \brief Test that we can read the "role" keyword.
 *
...
TEST_SUITE(fido_scanner_read_token_keyword_role);
...
/**
 * \brief If this doesn't start with 'r', it's a failure.
 */
TEST(not_role)
{
    fido_scanner* scanner = nullptr;
