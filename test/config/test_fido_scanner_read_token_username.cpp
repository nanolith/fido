/**
 * \file test/config/test_fido_scanner_read_token_username.c
 *
 * \brief Test that we can read a username token.
 *
...
TEST_SUITE(fido_scanner_read_token_username);
...
/**
 * \brief Usernames can begin with underscores.
 */
TEST(underscore)
{
    fido_scanner* scanner = nullptr;
...
/**
 * \brief Usernames cannot start with numbers.
 */
TEST(number_fail)
{
    fido_scanner* scanner = nullptr;
