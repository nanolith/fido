/**
 * \file config/fido_scanner_read_token_keyword_cmd.c
 *
 * \brief Attempt to scan a cmd keyword, falling back to username if 'c'
...
bad_input:
    ...
    MODEL_CONTRACT_CHECK_POSTCONDITIONS(
        fido_scanner_read_token_keyword_cmd, retval, details, scanner);
