...
/* function contract preconditions. */
MODEL_CONTRACT_PRECONDITIONS_BEGIN(
    fido_scanner_complete_token_simple, fido_token_details* details,
    fido_scanner* scanner, int type)
        /* token details point to a valid region of memory. */
        MODEL_CHECK_OBJECT_RW(details, sizeof(*details));
        /* scanner is valid. */
...
MODEL_CONTRACT_PRECONDITIONS_END(fido_scanner_complete_token_simple)

/* function contract postconditions. */
MODEL_CONTRACT_POSTCONDITIONS_BEGIN(
    fido_scanner_complete_token_simple, int retval,
    fido_token_details* details, fido_scanner* scanner, int type)
        /* on success... */
        if (FIDO_SCANNER_TOKEN_TYPE_BAD_INPUT != retval
         && FIDO_SCANNER_TOKEN_TYPE_EOF != retval)
...
/* function contract preconditions. */
MODEL_CONTRACT_PRECONDITIONS_BEGIN(
    fido_scanner_complete_token_string, fido_token_details* details,
    fido_scanner* scanner)
        /* token details point to a valid region of memory. */
        MODEL_CHECK_OBJECT_RW(details, sizeof(*details));
        /* scanner is valid. */
        MODEL_ASSERT(property_fido_scanner_valid(scanner));
MODEL_CONTRACT_PRECONDITIONS_END(fido_scanner_complete_token_string)

/* function contract postconditions. */
MODEL_CONTRACT_POSTCONDITIONS_BEGIN(
    fido_scanner_complete_token_string, int retval,
    fido_token_details* details, fido_scanner* scanner)
        /* on success... */
        if (FIDO_SCANNER_TOKEN_TYPE_BAD_INPUT != retval
         && FIDO_SCANNER_TOKEN_TYPE_EOF != retval)
...
MODEL_CONTRACT_POSTCONDITIONS_END(fido_scanner_complete_token_string)
