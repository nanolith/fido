...
/* function contract preconditions. */
MODEL_CONTRACT_PRECONDITIONS_BEGIN(
    fido_config_parse_role_as_clause, fido_config_role* role,
    fido_scanner* scanner)
        /* role is valid. */
        MODEL_ASSERT(property_fido_config_role_valid(role));
        /* scanner is valid. */
        MODEL_ASSERT(property_fido_scanner_valid(scanner));
MODEL_CONTRACT_PRECONDITIONS_END(fido_config_parse_role_as_clause)
...
/* function contract preconditions. */
MODEL_CONTRACT_PRECONDITIONS_BEGIN(
    fido_config_parse_role_command, fido_config_role* role,
    fido_scanner* scanner)
        /* role is valid. */
        MODEL_ASSERT(property_fido_config_role_valid(role));
        /* scanner is valid. */
        MODEL_ASSERT(property_fido_scanner_valid(scanner));
MODEL_CONTRACT_PRECONDITIONS_END(fido_config_parse_role_command)

/* function contract postconditions. */
MODEL_CONTRACT_POSTCONDITIONS_BEGIN(
    fido_config_parse_role_command, int retval, fido_config_role* role,
    fido_scanner* scanner)
        /* role is valid. */
        MODEL_ASSERT(property_fido_config_role_valid(*role));
        /* scanner is valid. */
...
MODEL_CONTRACT_POSTCONDITIONS_END(fido_config_parse_role_command)
...
/* function contract postconditions. */
MODEL_CONTRACT_POSTCONDITIONS_BEGIN(
    fido_config_parse_role_variable, int retval, fido_config_role* role,
    fido_scanner* scanner)
        /* role is valid. */
        MODEL_ASSERT(property_fido_config_role_valid(*role));
        /* scanner is valid. */
...
/* function contract preconditions. */
MODEL_CONTRACT_PRECONDITIONS_BEGIN(
    fido_config_parse_role_permission, fido_config_role* role,
    fido_scanner* scanner)
        /* role is valid. */
        MODEL_ASSERT(property_fido_config_role_valid(role));
        /* scanner is valid. */
        MODEL_ASSERT(property_fido_scanner_valid(scanner));
MODEL_CONTRACT_PRECONDITIONS_END(fido_config_parse_role_permission)

/* function contract postconditions. */
MODEL_CONTRACT_POSTCONDITIONS_BEGIN(
    fido_config_parse_role_permission, int retval, fido_config_role* role,
    fido_scanner* scanner)
        /* role is valid. */
        MODEL_ASSERT(property_fido_config_role_valid(role));
        /* scanner is valid. */
...
MODEL_CONTRACT_POSTCONDITIONS_END(fido_config_parse_role_permission)
