/**
 * \file models/config/fido_config_parse_role_variable_shadow_sink/main.c
 *
 * \brief Model checks for \ref fido_config_parse_role_variable_shadow_sink.
 *
...
int main(int argc, char* argv[])
{
    ...
    /* parse a variable for a role. */
    retval = fido_config_parse_role_variable(role, scanner);
    if (0 != retval)
    {
        goto cleanup_role;
    }
