/**
 * \file models/config/fido_scanner_read_token_keyword_as_shadow/main.c
 *
 * \brief Model checks for fido_scanner_read_token_keyword_as_shadow.
 *
...
int main(int argc, char* argv[])
{
    ...
    /* attempt to read the as keyword. */
    retval = fido_scanner_read_token_keyword_as(&details, scanner);
