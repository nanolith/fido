/**
 * \file models/config/fido_config_parse_role_as_clause_shadow_sink/main.c
 *
 * \brief Model checks for \ref fido_config_parse_role_as_clause_shadow_sink.
 *
...
int main(int argc, char* argv[])
{
    ...
    /* parse an as clause for a role. */
    retval = fido_config_parse_role_as_clause(role, scanner);
    if (0 != retval)
    {
        goto cleanup_role;
    }
