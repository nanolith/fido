/**
 * \file models/config/fido_scanner_read_token_string_shadow/main.c
 *
 * \brief Model checks for fido_scanner_read_token_string_shadow.
 *
...
int main(int argc, char* argv[])
{
    ...
    retval = fido_scanner_read_token_string(&details, scanner);
