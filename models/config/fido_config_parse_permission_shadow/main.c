/**
 * \file models/config/fido_config_parse_permission_shadow/main.c
 *
 * \brief Model checks for \ref fido_config_parse_permission_shadow.
 *
...
int main(int argc, char* argv[])
{
    ...
    /* parse a permission instance. */
    retval = fido_config_parse_permission(&perm, scanner);
    if (0 != retval)
    {
