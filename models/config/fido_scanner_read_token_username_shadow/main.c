/**
 * \file models/config/fido_scanner_read_token_username_shadow/main.c
 *
 * \brief Model checks for fido_scanner_read_token_username_shadow.
 *
...
int main(int argc, char* argv[])
{
    ...
    /* attempt to read a username token. */
    retval = fido_scanner_read_token_username(&details, scanner);
