/**
 * \file models/config/fido_scanner_read_token_group_shadow/main.c
 *
 * \brief Model checks for fido_scanner_read_token_group_shadow.
 *
...
int main(int argc, char* argv[])
{
    ...
    /* attempt to read a group token. */
    retval = fido_scanner_read_token_group(&details, scanner);
